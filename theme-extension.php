...
function my_load_scripts($hook) {
	...
	$forselprop_ver = date("ymd-Gis", filemtime( plugin_dir_path( __FILE__ ) . 'assets/css/for-sale-properties.css' ));
	...
	if ( is_single() && 'property' == get_post_type() && has_term( 'for-sale', 'property-status' )) {
		wp_enqueue_style( 'for-sale-properties', 	plugins_url( 'assets/css/for-sale-properties.css', 	 __FILE__ ), false, $forselprop_ver );
	}
